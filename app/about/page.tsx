...
import { ArrowRight, Wind, Leaf, Car, Droplets, Wrench, ImageOff } from 'lucide-react'
...
export default function AboutPage() {
  return (
    <div className="min-h-dvh w-full overflow-x-hidden" style={{ background: '#16181C', color: '#F2F0EB' }}>
      ...
      {/* ── Reviews pointer (full reviews live at /reviews) ── */}
      <section id="testimonials" style={{ background: '#F2F0EB', color: '#16181C' }}>
        <div className="mx-auto max-w-7xl px-5 py-16 sm:px-8 lg:py-24">
          <ScrollReveal>
            <div className="border-2 p-8 sm:p-12" style={{ borderColor: '#16181C' }}>
              ...
              <p className="mt-6 max-w-2xl text-[17px] leading-relaxed" style={{ color: 'rgba(22,24,28,0.72)' }}>
                Rated 5.0 on Google. Read every review, plus a full client story, on the reviews page.
              </p>
              <Link
                href="/reviews"
