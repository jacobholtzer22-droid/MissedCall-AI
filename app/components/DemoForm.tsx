    ...
    <form onSubmit={handleSubmit} className="bg-gray-900/80 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-6">
        ...
        <div>
          ...
          <input type="tel" name="phone" required placeholder="(555) 123-4567" className="w-full px-4 py-3 bg-gray-800 border border-white/10 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500" />
        </div>
      </div>
      <div className="mb-6">
